...
namespace Integrations.EasyCharacterMovement
{
    public sealed class AgentControllerECM : BaseCharacterController
    {
        /// <summary>
        ...
        /// <summary>
        /// Overrides 'BaseCharacterController' HandleInput method, default has Movement, Jump, Crouch, Pause built in.
        /// We don't want any of this as all movement (input or AI) is required to come from the CharacterManager.
        /// </summary>
